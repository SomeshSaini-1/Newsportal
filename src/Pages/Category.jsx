...
const Category = () => {
  ...
  const fetchNews = async (categoryId, pageNum = 1, append = false) => {
    ...
    try {
      const url = `${API_BASE_URL}/hindinews?category=${categoryId}&page=${pageNum}&limit=12&status=PUBLISHED`;
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
        {news.length === 0 ? (
          <div className="text-center py-20 sm:py-32">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mb-3">कोई संबंधित कहानियां नहीं हैं</h2>
            <p className="text-gray-600 max-w-md mx-auto">
              इस श्रेणी में अभी तक कोई प्रकाशित लेख नहीं है। कृपया बाद में पुनः प्रयास करें।
            </p>
          </div>
        ) : (
          <>
